...
git_repos["dotfiles/vim/bundle/BufExplorer"]="git://github.com/jlanzarotta/bufexplorer.git"
...
git_repos["dotfiles/vim/bundle/RagTag"]="git://github.com/tpope/vim-unimpaired.git"
